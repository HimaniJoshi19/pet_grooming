...
/// TextEditField
class TextEditFieldPrefixSuffixIcon extends StatefulWidget {
  /// constructor
  const TextEditFieldPrefixSuffixIcon({
    super.key,
...
class _TextEditFieldPrefixSuffixIconState
  ...
  @override
  void didUpdateWidget(TextEditFieldPrefixSuffixIcon oldWidget) {
