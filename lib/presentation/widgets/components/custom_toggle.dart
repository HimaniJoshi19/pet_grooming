...
class FlutterSwitch extends StatefulWidget {
  ...
  const FlutterSwitch({
    ...
    this.toggleShape = BoxShape.rectangle,
...
class FlutterSwitchState extends State<FlutterSwitch>
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.value) {
      toggleColor =
          widget.activeToggleColor ?? widget.toggleColor ?? Colors.white;
      switchColor = widget.activeColor;
      switchBorder =
          widget.activeSwitchBorder ?? widget.switchBorder ?? const Border();
      toggleBorder =
          widget.activeToggleBorder ?? widget.toggleBorder ?? const Border();
      icon = widget.activeIcon ?? const Offstage();
    } else {
      toggleColor =
          widget.inactiveToggleColor ?? widget.toggleColor ?? Colors.white;
      switchColor = widget.inactiveColor;
      switchBorder =
          widget.inactiveSwitchBorder ?? widget.switchBorder ?? const Border();
      toggleBorder =
          widget.inactiveToggleBorder ?? widget.toggleBorder ?? const Border();
      icon = widget.inactiveIcon ?? const Offstage();
    }
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        //shape: widget.toggleShape ?? BoxShape.circle,
                        color: toggleColor,
                        border: toggleBorder,
                      ),
                      child: icon,
